...
def main():
    ...
    your_app_client_id = os.environ.get('client_id') or os.environ.get('CORTEX_CLIENT_ID')
    your_app_client_secret = os.environ.get('client_secret') or os.environ.get('CORTEX_CLIENT_SECRET')
    ...
    # Free-tier streams (no raw EEG): met, pow, mot, dev
    # Add 'eeg' only if you have consumer device (Insight/MN8) or paid license
    streams = ['met', 'pow', 'mot', 'dev']
    s.start(streams)
