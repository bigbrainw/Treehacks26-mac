...
JETSON_URL = os.environ.get(
    'JETSON_URL',
    'https://3e75-68-65-175-56.ngrok-free.app/eeg'
)
SEND_INTERVAL_SEC = float(os.environ.get('SEND_INTERVAL', '2.0'))


class StreamToJetson:
    def __init__(self, app_client_id, app_client_secret, jetson_url=JETSON_URL, **kwargs):
...
def main():
    ...
    jetson_url = os.environ.get('JETSON_URL', JETSON_URL)
    ...
    s = StreamToJetson(client_id, client_secret, jetson_url=jetson_url)
    s.start()
